...
internal class RuntimeShaderCacheImpl : RuntimeShaderCache {
    ...
    // The API 33 constructor below is reachable only through the two guarded call sites — the lens
    // effect and the highlight styles both return early on `isRuntimeShaderSupported()` — and the
